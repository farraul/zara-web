...
const DetailsProduct = ({ data }: Props) => {
    ...
    const { handleColorCurrent, handleStorageCurrent, storageCurrent, colorCurrent } = useProduct();
        ...
        <div className="w-full">
            <div className="flex w-full flex-col xl:flex-row justify-start items-start xl:space-x-8">
                ...
                <div className="w-full xl:w-1/2 xl:mb-12 xl:self-end flex flex-col space-y-6 pb-10">
                    <h1 className="text-3xl font-light text-gray-900 uppercase">{data.name}</h1>
            ...
            <div className="w-full flex flex-col mt-10 gap-10 items-start justify-center">
